...
class ColorResources {
  ...
  static Color getPrimaryColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xff3647B2) : Color(0xff0F5EF7);
  }
  static Color getSecondaryColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xff28347C) : Color(0xff011C4B);
  }
  ...
  static Color getPrimaryBGColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xffFFFFFF) : Color(0xff0F5EF7);
  }
  static const Color BLACK = Color(0xff000000);
  static const Color WHITE = Color(0xffFFFFFF);
  static const Color COLOR_PRIMARY = Color(0xff0F5EF7);
  static const Color SECONDARY_PRIMARY = Color(0xff011C4B);
  static const Color LIGHT_SKY_BLUE = Color(0xff8DBFF6);
  static const Color HARLEQUIN = Color(0xff3FCC01);
  static const Color CERISE = Color(0xffBA68C8);
  static const Color GREY = Color(0xffF1F1F1);
  static const Color RED = Color(0xFFC80404);
